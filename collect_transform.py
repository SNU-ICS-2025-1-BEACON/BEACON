...
dataset.setPeriodsOfInterests([
    ...
    },
    {
        ...
        "name": "TTNet",
        "label": "no_anomaly",
        "start_time": utils.getTimestamp(2004, 12, 24, 9, 20, 0) - 60*30 - 3600, 
        "end_time": utils.getTimestamp(2004, 12, 24, 9, 20, 0) + 60*30 - 3600, 
    },
    {
        "name": "IndoSat",
        "label": "no_anomaly",
        "start_time": utils.getTimestamp(2014, 4, 2, 18, 25, 0) - 60*30 - 3600, 
        "end_time": utils.getTimestamp(2014, 4, 2, 18, 25, 0) + 60*30 - 3600, 
    },
    {
        "name": "TM",
        "label": "no_anomaly",
        "start_time": utils.getTimestamp(2015, 6, 12, 8, 43, 0) - 60*30 - 3600, 
        "end_time": utils.getTimestamp(2015, 6, 12, 8, 43, 0) + 60*30 - 3600
    },
    {
        "name": "AWS",
        "label": "no_anomaly",
        "start_time": utils.getTimestamp(2016, 4, 22, 17, 10, 0) - 60*30 - 3600, 
        "end_time": utils.getTimestamp(2016, 4, 22, 17, 10, 0) + 60*30 - 3600
    },
    {
        "name": "Google",
        "label": "no_anomaly",
        "start_time": utils.getTimestamp(2017, 8, 25, 3, 22, 0) - 60*30 - 3600, 
        "end_time": utils.getTimestamp(2017, 8, 25, 3, 22, 0) + 60*30 - 3600, 
    },
    {
        "name": "ChinaTelecom",
        "label": "no_anomaly",
        "start_time": utils.getTimestamp(2019, 6, 6, 9, 44, 0) - 60*30 - 3600, 
        "end_time": utils.getTimestamp(2019, 6, 6, 9, 44, 0) + 60*30 - 3600, 
    },
    {
        "name": "India",
        "label": "no_anomaly",
        "start_time": utils.getTimestamp(2021, 4, 16, 13, 48, 0) - 60*30 - 3600, 
        "end_time": utils.getTimestamp(2021, 4, 16, 13, 48, 0) + 60*30 - 3600, 
    },
])

# run the data collection
utils.runJobs(dataset.getJobs(), folder+"collect_jobs", nbProcess=8) 
